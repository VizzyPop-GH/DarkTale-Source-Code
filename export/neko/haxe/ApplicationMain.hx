...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("hi mom (aka the game lol)", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("hi mom (aka the game lol)", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "e";
		app.meta["file"] = "hi mom (aka the game lol)";
		app.meta["name"] = "DarkTale";
